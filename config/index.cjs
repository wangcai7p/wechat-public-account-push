...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxfc7221eb2da4e480',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '1a65b23b60bc969a39582e130fb796ae',
  ...
  USERS: [
    {
      ...
      id: 'osX6d6cmQmgkA9i8Q0A5mmoh3z7w',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'arw7cVFBjRiht1k4kWlifwukkltWx_W11AwYwt-a6d8',
      // 所在省份
      province: '江西',
      // 所在城市
      city: '景德镇',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '小可爱', year: '2002', date: '01-27',
        },
        {
          type: '生日', name: '大帅锅', year: '2020', date: '02-24',
        }
...
//         }
      ...
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2022-06-25' }
        // 结婚纪念日
...
//         { keyword: 'ex_day', date: '2022-09-10' }
  ...
  CALLBACK_TEMPLATE_ID: '5NCun4we2aJvAg9UhmeHX8FCuxJJSa2-T2LWKkctaiA',
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {
      type: '*生日', name: '小可爱', year: '2002', date: '01-27', isShowAge: true,
    },
    {
      type: '生日', name: '大帅锅', year: '2002', date: '02-24',
    }
    // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
//     {
